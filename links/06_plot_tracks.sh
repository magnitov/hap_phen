...
pyGenomeTracks --tracks ${INPUT_PATH}/example_tracks/link_ATACseq_TTseq_TBC1D4.ini \
	-o ${INPUT_PATH}/example_tracks/link_ATACseq_TTseq_TBC1D4.png --dpi 300 \
	--region chr13:75,265,000-75,500,000 --width 14 --height 15 --fontSize 8 --trackLabelHAlign right
